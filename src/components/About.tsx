export default function About() {
    ...
    const paragraphs = [
        ...
        "Programowaniem stron zajmuję się od 3 lat, a swoje umiejętności rozwijałem zarówno w technikum na kierunku technik programista, jak i teraz samodzielnie, codziennie poszerzając swoją wiedzę.",
